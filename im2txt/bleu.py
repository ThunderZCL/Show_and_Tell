...
if __name__ == '__main__': 
    ...
    predict_sentence ='a group of people sitting around a table with food .'
    train_sentences = ['a group of people sitting at a table with food.', 'a man woman and boy are sitting at a table .', 'a man woman and child eating together at a restaurant .','a boy sitting between a man and a woman .','a young child lady and man sitting in a booth at a table .']
...
'''
0) a group of people sitting around a table . (p=0.002578)
1) a group of people sitting around a table eating food . (p=0.001358)
2) a group of people sitting around a table with food . (p=0.001115)
