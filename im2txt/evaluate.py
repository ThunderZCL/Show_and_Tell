...
tf.flags.DEFINE_string("input_file_pattern", "/media/thunder/soft/MSCOCO-tfrecord/tfrecord/val-?????-of-00004",
                       "File pattern of sharded TFRecord input files.")
tf.flags.DEFINE_string("checkpoint_dir", "./saver",
                       "Directory containing model checkpoints.")
tf.flags.DEFINE_string("eval_dir", "./save1", "Directory to write event logs.")
